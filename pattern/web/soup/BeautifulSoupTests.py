...
class WriteOnlyCode(SoupTest):
    ...
    def testTagReplacement(self):
        ...
        show.replaceWith(no)
        self.assertEqual(str(soup), "<html>There's  business like <b>no</b> business</html>")
...
class CleanupOnAisleFour(SoupTest):
    ...
    def testEntityConversions(self):
        ...
        self.assertEqual(str(soup), "&lt;&lt;sacr&eacute; bleu!&gt;&gt;")
        ...
        text = "&lt;&trade;&apos;"
        soup = BeautifulStoneSoup(text, convertEntities=xmlEnt)
        self.assertEqual(str(soup), "&lt;&trade;'")
    ...
    def testNonBreakingSpaces(self):
        ...
        self.assertEqual(str(soup), "<a>\xa0\xa0</a>")
    ...
    def testEntitiesInAttributeValues(self):
        ...
        soup = BeautifulSoup('<x t="&gt;&trade;">',
                             convertEntities=BeautifulStoneSoup.HTML_ENTITIES)
        self.assertEqual(str(soup), '<x t="&gt;\\u2122"></x>')
...
class EncodeRed(SoupTest):
    ...
    def testUnicodeDammitStandalone(self):
        ...
        self.assertEqual(dammit.str, "<foo>&#x2019;</foo>")

        hebrew = "\xed\xe5\xec\xf9"
        dammit = UnicodeDammit(hebrew, ["iso-8859-8"])
        self.assertEqual(dammit.str, '\\u05dd\\u05d5\\u05dc\\u05e9')
    ...
    def testGarbageInGarbageOut(self):
        ...
        self.assertEqual(utf8, '<foo>\xc3\xbc</foo>')
    ...
    def testRewrittenXMLHeader(self):
        ...
        self.assertEqual(soup.originalEncoding, "euc-jp")
    ...
    def testRewrittenMetaTag(self):
        ...
        self.assertEqual(soup.originalEncoding, "shift-jis")

        content_type_tag = soup.meta['content']
        self.assertEqual(content_type_tag[content_type_tag.find('charset='):],
        ...
        self.assertEqual(str(soup), (
                ...
                '</pre></body></html>'))
        self.assertEqual(soup.renderContents("shift-jis"),
